...
class Model_execute:
    ...
    def adjust_predict_d(self, date_predict_init):
        ...
        fitted2 = fitted2[(fitted2.index >= date_slice_plot)].iloc[ num_plot: ]
        ...
        # predicted plot
        predicted = df_data_all[f"{self.folder.lower()}_predicted"].iloc[num_plot:]
        predicted.plot(color=self.color3)
